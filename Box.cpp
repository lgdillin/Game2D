...
Box::Box(glm::vec3 _pos, glm::vec3 _scale, bool _anc, float _angle, HeightZone _zone) 
...
void Box::buildTexture() {
	bool alphaMode = true;
	std::string fileLocation = "./resources/textures/brick.png";
	int width = 0;
	int height = 0;
	int bitDepth = 0;
...
void Box::transform(glm::mat4 &_model) {
...
void Box::recomputeBoundingVolume() {
